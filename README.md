...
С помощью популярного формата WebP фото сжимается на 25-30%[^10], поэтому при расчете общего объема пользовательских данных допольнительно умножим его на 0,7.
- **Средний объём на пользователя:** ~ **2 МБ**
- **Общий объём хранения данных пользователей:**
  - `14 000 000 × 2 МБ × 0,7  = 19 600 000 МБ = 19,6 ТБ = 0,0196 ПБ`
...
| Данные пользователей | **0,0196 ПБ** |
