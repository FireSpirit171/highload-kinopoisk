...
## Прирост дискового пространства (см. задание 2)
...
| Пользователи (лёгкая)             | 0.0012  | 0.002   | 0.006 MB   | 0.012 MB   | 1      |
...
1. **CPU request (CPU/req)**:
   ...
   - Сервис легкой бизнес-логики.
   - Норма: 1 CPU на 2000 RPS.
   - Нагрузка: 30 RPS.
   - Делим: 30 RPS \* 0,0005 CPU/RPS = 0,015 CPU.
   - Для Владивостока (10%): 0,015 CPU \* 0,1 = 0.0015 CPU/req

2. **CPU limit (CPU/lim)**:

   - Задаём лимит на 30–40% выше CPU/req.
   - 0.0015 × 1.4 ≈ 0.002 CPU.

3. **RAM request (RAM/req)**:

   - Норма: 50 MB на 500 RPS для легкой логики или 0,3 MB на 3 RPS.
   - 0,3 × 5 MB = 1,5 MB.
...
- Месячная: 45 000 + 37 600 + 11 200 = **93 800 ₽/мес**
