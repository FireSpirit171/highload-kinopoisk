...
Для эффективного масштабирования мы будем использовать шардирование в нескольких таблицах. С помощью Range Based шардирования можно распределить таблицы на шарды по 1 млн. записей, чтобы эффективно управлять ими.

- Таблицы, шардируемые по **film_id**
  - Films
  - Revies
  - Ratings
...
- Таблицы, шардируемые по **user_id**
  - Watch_history
  - Favourites
...
- Для каждого шарда создаем партиции
```sql
